...
#include "autoware_localization_error_monitor/node.hpp"
...
: Node("autoware_localization_error_monitor"), updater_(this)
{
  ...
  updater_.setHardwareID("autoware_localization_error_monitor");
