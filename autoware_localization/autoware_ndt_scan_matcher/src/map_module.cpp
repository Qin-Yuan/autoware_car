...
#include "autoware_ndt_scan_matcher/map_module.hpp"
...
: ndt_ptr_(ndt_ptr), ndt_ptr_mutex_(ndt_ptr_mutex)
{
  ...
  // std::cout << "\033[31m Received pointcloud map ... \033[0m"<< std::endl;
  RCLCPP_INFO_STREAM_THROTTLE(node->get_logger(), *node->get_clock(), 1, "waiting pointcloud map ... ");
...
{
  // RCLCPP_WARN_STREAM_THROTTLE(this->get_logger(), *this->get_clock(), 1, "Received pointcloud map ... ");
  // std::cout << "\033[31m Received pointcloud map ... \033[0m"<< std::endl;
