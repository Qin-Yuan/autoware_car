...
#include "autoware_vehicle_velocity_converter/vehicle_velocity_converter.hpp"

VehicleVelocityConverter::VehicleVelocityConverter() : Node("autoware_vehicle_velocity_converter")
{
