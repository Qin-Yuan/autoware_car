...
struct TrajectoryOptions {
  ...
  // 定位初始化参数
  bool localization ;
  double inital_pose_x ;
  double inital_pose_y ;
  double inital_pose_z ;
  double inital_orientation_x ;
  double inital_orientation_y ;
  double inital_orientation_z ;
  double inital_orientation_w ;
};
