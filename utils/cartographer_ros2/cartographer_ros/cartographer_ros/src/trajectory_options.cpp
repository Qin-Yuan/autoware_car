...
TrajectoryOptions CreateTrajectoryOptions(
  ...
  // 位置信息初始化
  options.localization = lua_parameter_dictionary->GetBool("localization");
  options.inital_pose_x = lua_parameter_dictionary->GetDouble("inital_pose_x");
  options.inital_pose_y = lua_parameter_dictionary->GetDouble("inital_pose_y");
  options.inital_pose_z = lua_parameter_dictionary->GetDouble("inital_pose_z");
  options.inital_orientation_x = lua_parameter_dictionary->GetDouble("inital_orientation_x");
  options.inital_orientation_y = lua_parameter_dictionary->GetDouble("inital_orientation_y");
  options.inital_orientation_z = lua_parameter_dictionary->GetDouble("inital_orientation_z");
  options.inital_orientation_w = lua_parameter_dictionary->GetDouble("inital_orientation_w");
